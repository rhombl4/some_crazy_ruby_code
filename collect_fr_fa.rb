...
mode = 'FA'
model_glob = 'fmodels/FR*_tgt.mdl'
...
models.each do |mdl|
  ...
  traces += Dir.glob("out/line/#{name}.nbt")
  traces += Dir.glob("fr_out/tgt_*/#{name}.nbt")
  ...
  if energy != sota_en
    #puts("cp #{fn} fr_out/tgt_sota")
    system("cp #{fn} fr_out/tgt_sota")
  end
end
